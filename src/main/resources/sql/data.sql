...
insert into trip (id,category,region,country,title,price,tags,duration,rating,departure_date,end_date_to_sign) values (2004,'HISTORY_AND_CULTURE','Africa','Morocco','Morocco’s mountains and medinas',3190,'AncientWonders,PhotographyBomb,FascinatingFauna,ArchitecturalWonders',11,4.7,null,null);
...
insert into trip (id,category,region,country,title,price,tags,duration,rating,departure_date,end_date_to_sign) values (2009,'HIDDEN_CITIES','Asia','Jordan','Petra: Lost city of Arabia',2274,'PhotographyBomb,ArchitecturalWonders,HistoryAndMistery',10,4.1,null,null);
