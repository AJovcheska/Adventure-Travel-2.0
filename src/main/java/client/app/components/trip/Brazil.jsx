...
var Brazil = React.createClass({
  ...
  componentDidMount: function () {
    ...
    backendApi.getTripById("2008").then((response) => {
      this.setState({
  ...
  handleFavourites: function () {
    ...
    backendApi.addTripForUser(username, "2008").then((response) => {
      ...
      backendApi.getTripById("2008").then((response) => {
        ...
        backendApi.updateSeats("2008", availableSeats - 1).then((response) => {
          console.log(response);
        });
      });
              ...
              <div className="row">
                <div className="content-body event-content-body col-md-11 trip-content-body">
                  <section id="event-body" className="item-body">
                    ...
                    <ul>
                      <li><strong>Greatest diversity of wildlife of any country on the planet:</strong> Brazil is home
                        to 60% of the Amazon Rainforest
                      </li>
                      <li><strong>Carnival Gala at a Belle Époque atelier</strong>: On our final night, transform into
                        ...
                        museums in South America: the <a
                    ...
                    <section id="event-trip-itinerary">
                      ...
                      <div className="trip-day-wrap">
                        ...
                        <ul className="tripsUl">
                          <li>When you arrive in Rio your local guide will be waiting to meet you and will take you to
                            your hotel which is located on the end of Copacabana Beach.
                          </li>
                        </ul>
                      ...
                      <div className="trip-day-wrap">
                        ...
                        <ul className="tripsUl">
                          <li>This morning's excursion will take you to visit Sugar Loaf Mountain, one of the most
                            famous landmarks of the city. You will take two cable cars with your guide to reach the top
                            of Sugar Loaf Mountain to appreciate some of the best views across the city.
                          </li>
                          <li>This afternoon you will be picked up from your hotel in an open top jeep and taken into
                            the Tijuca Atlantic Forest, the largest urban forest in the World. During the afternoon you
                            may come across monkeys, sloths and exotic birds.
                          </li>
                        </ul>
                      ...
                      <div className="trip-day-wrap">
                        ...
                        <ul className="tripsUl">
                          <li>Transfer to the airport for your flights to Campo Grande. When you arrive you at Campo
                            Grande you will be met and driven to the airstrip at Aquidauana, a journey of approximately
                            3 hours, where you will board your light aircraft to Fazenda Barranco Alto.
                          </li>
                        </ul>
                      ...
                      <div className="trip-day-wrap">
                        ...
                        <ul className="tripsUl">
                          <li>The Fazenda Barranco Alto offers a number of activities to its guests, such as walking
                      ...
                      <div className="trip-day-wrap">
                        ...
                        <ul className="tripsUl">
                          <li>This morning you will be flown back to Aquiduana and then driven the rest of the way to
                            Campo Grande to board your flight to Florianopolis, via Sao Paulo.
                          </li>
                      ...
                      <div className="trip-day-wrap">
                        ...
                        <ul className="tripsUl">
                          <li>Every year between July and November Southern Right whales come to give birth and care for
                            their young.
                          </li>
                          <li> Today you will be taken out on a boat to get up close to the whales. You then have the
                            afternoon free to enjoy your hotel.
                          </li>
                        </ul>
                        <img src="../images/brazil2.jpg"/>
                      </div>
                      <div className="trip-day-wrap">
                        ...
                        <ul className="tripsUl">
                          <li>This morning you will be picked up from your hotel and taken to Praia do Rosa, where you
                            will embark on a morning of horse riding along the dunes to Praia da Barra.
                          </li>
                          <li>The return journey takes a different route through the forest. At the end of the excursion
                            you will be taken back to your hotel where you will have the rest of the day at leisure.
                          </li>
                        </ul>
                        <img src="../images/brazil1.jpg"/>
                      </div>
                      <div className="trip-day-wrap">
                        ...
                        <ul className="tripsUl">
                          <li>You will be transferred to the airport in plenty of time for your flight to Sao Paulo and
