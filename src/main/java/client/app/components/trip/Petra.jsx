                           ...
                           <section id="event-trip-itinerary">
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>The tour starts in the the town of Madaba, home to some of the most extraordinary mosaics in the Middle East.</li>
                                 </ul>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>A busy day ahead of us, we will first visit Madaba’s famous Byzantine Church, before heading across to Mt Nebo, after which we will head north to the Roman city of Jerash.</li>
                                 </ul>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>This morning we will head to Ajloun’s crusader-era castle before heading to the village of Rasun for lunch before walking through the hills to Orjan village, where we’ll overnight with our village host families.</li>
                                 </ul>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>This morning we'll take a walk through the surrounding area, before joining up with our vehicle and head towards the Dana Nature Reserve, stopping off at the stunning Crusader castle of Kerak on the way.</li>
                                 </ul>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>Today will be on foot as we follow the Wadi Dana Trail, walking from Dana to Feynan, covering approximately 14km.</li>
                                 </ul>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>We’ll head straight to Petra this morning and take a guided tour of the ancient Nabataean city of Petra.</li>
                                 </ul>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>Today we’ll return to Petra via the “secret road” of al-Madras, and visit the High Place of Sacrifice, and Royal Tombs.</li>
                                 </ul>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>Leaving Petra behind us we strike into the desert of Wadi Rum in 4WD jeeps for a full day of exploration.</li>
                                 </ul>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>We head towards the saline waters of the Dead Sea, the lowest place on earth, where there will be time to have a float before heading to Amman for our final night.</li>
