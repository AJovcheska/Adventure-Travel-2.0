...
var Everest = React.createClass({
  ...
  componentDidMount: function () {
    backendApi.getTripById("2002").then((response) => {
      this.setState({
  ...
  handleFavourites: function () {
    ...
    backendApi.addTripForUser(username, "2002").then((response) => {
      ...
      backendApi.getTripById("2002").then((response) => {
        ...
        backendApi.updateSeats("2002", availableSeats - 1).then((response) => {
          console.log(response);
        });
      });
                  ...
                  <section id="event-body" className="item-body">
                    ...
                    <section id="event-trip-itinerary">
                      ...
                      <div className="trip-day-wrap">
                        ...
                        <ul className="tripsUl">
                          <li>Enjoy a full day's guided tour of the Nepalese capital today, taking in the famous
                            historical monuments of Durbar Square including the Kumari Bahal, the old royal palace and
                            the residence of the living goddess. You will also visit the golden-topped stupa of
                            Swayambunath (The Monkey Temple) and the site of Pashupatinath, the holiest Hindu temple in
                            the Kathmandu Valley, situated beside the sacred waters of the Bagmati River.
                          </li>
                        </ul>
                      </div>
                      <div className="trip-day-wrap">
                        ...
                        <ul className="tripsUl">
                          <li>Leaving Kathmandu this morning you will take the exhilarating flight on to Lukla. The
                            starting point of the trek takes you down towards the Dudh Khosi River, following a
                            relatively easy trail on towards Phakding. A 3-4 hour hike today, lunch will be provided en
                            route and the distant peak of Mount Kusum Kangaru provides a spectacular backdrop to your
                            first overnight lodge. Overnight in Phakding. (B,L,D)
                          </li>
                        </ul>
                      </div>
                      <div className="trip-day-wrap">
                        ...
                        <ul className="tripsUl">
                          <li>Taking around six hours, today's trek sees you heading up towards Namche Bazaar, following
                            a meandering climb with views of Kusum Kangaroo and Thamsherku providing a stunning visual
                            accompaniment. With luck, if weather conditions allow, you may also spot your first sight of
                            Everest this morning. After lunch you'll begin the steep ascent up to the colourful town of
                            Namche, set high amongst the peaks of the Khumbu region. Spending the night here, the town
                            is amply equipped with restaurants, shops and internet cafes. (B,L,D)
                          </li>
                        </ul>
                      </div>
                      <div className="trip-day-wrap">
                        ...
                        <ul className="tripsUl">
                          <li>Today provides a chance to start acclimatising to the higher altitude, with a day hike
                            around Namche. It is important to spend this time getting more used to the challenges that
                            often come with trekking in the mountains, so an optional hike to nearby Syangboche is
                            recommended. Roughly an hour's climb from Namche, Syangboche provides some spectacular 360
                            degrees of the surrounding peaks, with Everest, Nuptse, Lhotse and Thamsherku clearly
                            visible. (B,L,D)
                          </li>
                        </ul>
                      </div>
                      <div className="trip-day-wrap">
                        ...
                        <ul className="tripsUl">
                          <li>The trek up to Deboche today takes around seven hours and provides some stunning views of
                            Thamsherku, Ama Dablan and Mount Everest. Stopping for lunch on the way to Phunge Thanga,
                            you'll then continue on up to the monastery at Thangboche, an ascent that will take some
                            three hours, but presents you with some spectacular panoramic views from the top. From here
                            it is then an easy hour's walk down towards your next lodge in Deboche. (B,L,D)
                          </li>
                        </ul>
                      </div>
                      <div className="trip-day-wrap">
                        ...
                        <ul className="tripsUl">
                          <li>Today's journey takes you on to the Comfort Lodge in Dingboche, a trek of some six hours
                            that takes you across the Pangboche Bridge and over the Budha Koshi. The trail along this
                            stretch of the climb narrows considerably, so take your time. After passing through
                            Pangboche, the trail on to Dingboche takes around another three hours. (B,L,D)
                          </li>
                        </ul>
                      </div>
                    </section>
              ...
              <nav className="trip-day-nav trip-sidebar-wrap hidden-xs hidden-sm hidden-print">
                ...
                <ul>
                  ...
                  <li className="trip-day-nav-li">
                    ...
                    <a className="detail-md trip-day-nav-link" href="#day3">Kathmandu - Lukla (2800m) - Phakding
                      (2610m)</a>
                  </li>
                  <li className="trip-day-nav-li">
                    <div className="trip-day-nav-num detail-sm-non-uppercase">Day 4</div>
                    <a className="detail-md trip-day-nav-link" href="#day4">Kathmandu - Lukla (2800m) - Phakding
                      (2610m)</a>
                  </li>
                  <li className="trip-day-nav-li">
                  ...
                  <li className="trip-day-nav-li">
                    ...
                    <a className="detail-md trip-day-nav-link" href="#day11">Lobuche - Gorakshep (5140m) - Everest Base
                      Camp (5346m)</a>
                  </li>
                  <li className="trip-day-nav-li">
                    <div className="trip-day-nav-num detail-sm-non-uppercase">Day 12</div>
                    <a className="detail-md trip-day-nav-link" href="#day12">Everest Base Camp - Kallapatthar - Pheriche
                      (4200m)</a>
                  </li>
                  <li className="trip-day-nav-li">
