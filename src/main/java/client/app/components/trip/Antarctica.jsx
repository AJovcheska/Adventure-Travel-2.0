              ...
              <div className="row">
                <header className="item-header trip-header js-item-header">
                  <div className="col-md-12">
                    ...
                    <h1 className="title-lg item-title trip-title">Antarctica Classic</h1>
                  </div>
                </header>
              </div>
              <div className="row">
                <div className="content-body event-content-body col-md-11 trip-content-body">
                  <section id="event-body" className="item-body">
                    ...
                    <ul>
                      <li>A dazzling landscape of vivid emeralds and violets, intense crimson light and sweeping
                        panoramas of blue ice
                      </li>
                    ...
                    <section id="event-trip-itinerary">
                      ...
                      <div className="trip-day-wrap">
                        ...
                        <ul className="tripsUl">
                          <li>Arrive in Ushuaia today and be transferred to your hotel. Enjoy the sights and sounds of
                            the world's most southerly city.
                          </li>
                        </ul>
                        <img className="detail-image-css" src="../images/Ushuaia.jpg"/>
                      </div>
                      <div className="trip-day-wrap">
                        <a name="day2"></a>
                        <div className="trip-day-nav-num trip-day-body-num">
                        ...
                        <ul className="tripsUl">
                          <li>Enjoy a free morning in Ushuaia where you can explore the town or the surrounding
                          ...
                          <li>Running through the Tierra del Fuego Archipelago, the channel forms part of the border
                            between Chile and neighbouring Argentina and this evening's sailing takes you south, towards
                            the open waters of Drake Passage and the vast Southern Ocean.
                          </li>
                        </ul>
                        <img className="detail-image-css" src="../images/Drake-Passage.jpg"/>
                      </div>
                      <div className="trip-day-wrap">
                        <a name="day3"></a>
                        <div className="trip-day-nav-num trip-day-body-num">
                        ...
                        <ul className="tripsUl">
                          <li>There will be daily lectures on board from resident polar experts and keep an eye out for
                            the first sightings of icebergs.
                          </li>
                        </ul>
                        <img className="detail-image-css" src="../images/drakePassage2.jpg"/>
                      </div>
                      <div className="trip-day-wrap">
                        <a name="day4"></a>
                        <div className="trip-day-nav-num trip-day-body-num">
                        ...
                        <ul className="tripsUl">
                          <li>Over the coming days you'll discover some of the most unique wildlife and experience some
                            of the most inspiring scenery on the planet, as you head for the vast white wilderness of
                            Antarctica.
                          </li>
                          <li>Attempting two shore landings a day, there will be opportunities to encounter Gentoo,
                            ...
                            a chance to learn about the peninsula's remarkable history.
                          </li>
                        </ul>
                        <img className="detail-image-css" src="../images/drakePassage3.jpg"/>
                      </div>
                      <div className="trip-day-wrap">
                        <a name="day5"></a>
                        <div className="trip-day-nav-num trip-day-body-num">
                        ...
                        <ul className="tripsUl">
                          <li>A further day to encounter the unique wildlife and spectacular landscapes of the Great
                            White Continent.
                          </li>
                        </ul>
                        <img className="detail-image-css" src="../images/Antarctic-Peninsula.jpg"/>
                      </div>
                      <div className="trip-day-wrap">
                        <a name="day6"></a>
                        <div className="trip-day-nav-num trip-day-body-num">
                        ...
                        <img className="detail-image-css" src="../images/drakePassage4.jpg"/>
                      </div>
                      <div className="trip-day-wrap">
                        <a name="day7"></a>
                        <div className="trip-day-nav-num trip-day-body-num">
                        ...
                        <ul className="tripsUl">
                          <li>Keep an eye out from the observation deck for some last-minute whale sightings as you head
                            back towards the port of Ushuaia and the end of this incredible adventure.
                          </li>
                        </ul>
                        <img className="detail-image-css" src="../images/drakePassage5.jpg"/>
                      </div>
                      <div className="trip-day-wrap">
                        <a name="day8"></a>
                        <div className="trip-day-nav-num trip-day-body-num">
                        ...
                        <img className="detail-image-css" src="../images/drakePassage6.jpg"/>
                      </div>
                      <div className="trip-day-wrap">
                        <a name="day9"></a>
                        <div className="trip-day-nav-num trip-day-body-num">
                        ...
                        <ul className="tripsUl">
                          <li>Disembark in Ushuaia early this morning, where your journey ends. Wild Frontiers can
                            arrange departure transfers and further travel in Argentina.
                          </li>
                          <li>Until the next adventure!</li>
                        </ul>
                        <img className="detail-image-css" src="../images/drakePassage7.jpg"/>
                      </div>
                    </section>
                  </section>
                  <div className="row">
              ...
              <nav className="trip-day-nav trip-sidebar-wrap hidden-xs hidden-sm hidden-print">
                ...
                <ul>
                  <li className="trip-day-nav-li">
                    ...
                    <a className="detail-md trip-day-nav-link" href="#day1">Welcome to Ushuaia!</a>
                  </li>
                  <li className="trip-day-nav-li">
                    <div className="trip-day-nav-num detail-sm-non-uppercase">Day 2</div>
                    <a className="detail-md trip-day-nav-link" href="#day2">Ushuaia - Drake Passage</a>
                  </li>
                  <li className="trip-day-nav-li">
                    <div className="trip-day-nav-num detail-sm-non-uppercase">Day 3</div>
                    <a className="detail-md trip-day-nav-link" href="#day3">Ushuaia - Drake Passage</a>
                  </li>
                  <li className="trip-day-nav-li">
                    <div className="trip-day-nav-num detail-sm-non-uppercase">Day 4</div>
                    <a className="detail-md trip-day-nav-link" href="#day4">South Shetland Islands</a>
                  </li>
                  <li className="trip-day-nav-li">
                    <div className="trip-day-nav-num detail-sm-non-uppercase">Day 5</div>
                    <a className="detail-md trip-day-nav-link" href="#day5">Antarctic Peninsula</a>
                  </li>
                  <li className="trip-day-nav-li">
                    <div className="trip-day-nav-num detail-sm-non-uppercase">Day 6</div>
                    <a className="detail-md trip-day-nav-link" href="#day6">Antarctic Peninsula</a>
                  </li>
                  <li className="trip-day-nav-li">
                    <div className="trip-day-nav-num detail-sm-non-uppercase">Day 7</div>
                    <a className="detail-md trip-day-nav-link" href="#day7">Antarctic Peninsula - Drake Passage</a>
                  </li>
                  <li className="trip-day-nav-li">
                    <div className="trip-day-nav-num detail-sm-non-uppercase">Day 8</div>
                    <a className="detail-md trip-day-nav-link" href="#day8">Antarctic Peninsula - Drake Passage</a>
                  </li>
                  <li className="trip-day-nav-li">
