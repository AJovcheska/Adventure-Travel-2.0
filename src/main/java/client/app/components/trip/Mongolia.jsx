                  ...
                  <div className="row">
                     <div className="content-body event-content-body col-md-11 trip-content-body">
                        <section id="event-body" className="item-body">
                           ...
                           <ul>
                              <li><strong>Dramatic natural landscapes:</strong> We'll take in a vast variety of scenery, from the Mongol Els sand dune to the famous steppe, from the Orkhon River to lush meadowland and dramatic rock formations.</li>
                              <li><strong>The Naadam Festival:</strong> Our adventure includes the celebratory competitions of "the three games of men"—archery, horseback riding, and wrestling—that pay tribute to Mongolia's warrior history.</li>
                              <li><strong>Hiking, horseback riding, and home cooking:</strong> You'll have many opportunities to roam beneath Mongolia's big blue skies—on foot, on horseback, and on camels—in addition to trying your hand at a few local dishes.</li>
                              <li><strong>Overnights in traditional ger camps:</strong> A ger is a traditional nomadic dwelling similar to a yurt and has served as home to generations of Mongolians. Throughout the trip, we'll be spending our nights in a range of remote settings, from the banks of Ögii Lake to multiple national parks.</li>
                           </ul>
                           <section id="event-trip-itinerary">
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   ...
                                   <li>Our group will meet in the evening for a welcome dinner and trip briefing before spending our first night in Mongolia.</li>
                                 </ul>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   ...
                                   <li>We'll visit the restored Gandan Monastery, a Tibetan-style Buddhist monastery home to several hundred monks. We'll also visit the National Museum of Mongolia, which covers over a millennia of local history, and Sükhbaatar Square. This central square is named for Damdiny Sükhbaatar, the "Father of Mongolia's Revolution in 1921 that brought independence from China.</li>
                                   <li>After lunch, we'll test our brain power at the International Intellectual and Puzzle Museum, also known as the IQ Museum. Created by puzzle master Tumen Ulzii, it is a place dedicated to curiosity, logic, and riddles.</li>
                                   <li>This evening, we'll enjoy a dinner and a traditional folklore concert, including a performance by Mongolia's national orchestra. </li>
                                 </ul>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>Today, we set out for the town of Zuunmod for the opening ceremony of the Naadam Festival! It'll be an early start to the day for the drive to the center of Töv province. Zuunmod, which means "Hundred Trees," has a population of just under 15,000, and is a quiet place outside of the festival season.</li>
                                   <li>When we arrive, we'll head first to our ger camp to drop off our luggage and shake our legs after the drive. We will then hop back into the vehicle for the shorter drive to the festival itself.</li>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>This morning, we head back into Ulaanbaatar. Our first stop is the city's central stadium, where we'll see an archery competition and hopefully the ankle-bone shooting game. </li>
                                   <li>After lunch in the city, we'll depart for Khustain Nuruu National Park. Declared a Specially Protected Area in 1993, the park—whose name means Birch Mountains—is home to 44 species of mammals and 217 species of birds, including Mongolia marmots, Eurasian Lynx, and lammergeier (bearded vulture). The last wild horses, or Takhi, were reintroduced here in 1992 and the population has slowly been stabilized.</li>
                                   <li>Our group will settle into a ger camp. Then, in the late afternoon, we'll drive to the mountains for the best chance to see the Takhi as they gather close to sunset. Along the way, we might also see red deer, gazelles, ibex, foxes, badgers, and any one of 29 species of local grasshoppers.</li>
                                   <li>We'll have dinner at the camp and then settle in for the night under a blanket of stars.</li>
                                 </ul>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>This morning we continue our journey by road to Karakorum (also Qara Qorum), capital of the Mongol Empire between 1235 and 1260. You can still see ruins of the 13th-century metropolis, from statues and roof tiles to crumbling kilns. When Kublai Khan took the throne of the empire in 1260, the city lost its key status and was reduced to an administrative center.</li>
                                   <li>We'll also stop by the Karakorum Museum, located in the modern-day town of Kharkhorin, to learn about the history of the town and the artifacts found in various nearby archaeological sites. While small, this museum is perhaps the best in the country outside of Ulaanbaatar.</li>
                                   <li>This afternoon, we'll take some time to relax and absorb the views along the Orkhon River, the longest river in Mongolia.</li>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>After breakfast, we depart the ancient capital and continue toward Ögii Lake, a freshwater expanse known for its fish and birdlife. </li>
                                   <li>We’ll stop along the way to discover more about the country’s history, zooming in on Turkish influences during the 7th to 8th centuries. Much of the territory of the original Turkish Empire encompassed major parts of modern-day Mongolia, and one of their main successors were the Uighurs, an ethnic group now concentrated in western China's Xinjiang Province that speaks a Turkic language and follows Islam.</li>
                                   <li>As we arrive at Ögii, any birdwatchers among you will not be disappointed. As the main source of fresh water in this region of the steppe, Ögii lake attracts many birds, including the beautiful Oriental Plover and the Bar-headed Goose.</li>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>Today, we drive to Khögnö Khan National Park. This natural reserve is home to two ecosystems: the steppe (shrub and grasslands) and the taiga (also known as boreal forest or snow forest). </li>
                                   <li>Here, we'll visit the Mongol Els sand dune, nearly 50 miles long and set in the park's dramatic desert landscape. </li>
                                   <li>We'll then ride two-humped (bactrian) camels for one to two hours to explore the local Buddhist monastery. While these camels are bred and domesticated, their wild brethren living in the Gobi Desert are now highly endangered.</li>
                                   <li>We’ll visit with the camel-breeding family and learn more about their nomadic life. </li>
                                   <li>In the evening we will take a leisurely walk in the sand dunes before spending the night in a ger camp.</li>
                                 </ul>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>After breakfast at the ger camp, we'll drive to visit a local nomadic family, who will be our hosts for the rest of the day. Today, we'll have a glimpse into the daily life of Mongolia's nomadic people.</li>
                                   <li>For lunch, we’ll have a cooking class and make buuz, a traditional Mongolian meal. </li>
                                   <li>During the day, you have several different options. You can horseback ride, or hike in the surrounding mountains and meadows. There will be ample opportunity to taste Airag. Made from fermented mare's milk, it's a favorite drink of Mongolians.</li>
                                 </ul>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>Today after breakfast, we'll bid farewell to our nomadic hosts and continue our journey. Tonight, we'll be setting up our ger camp in Gorkhi-Terelj National Park. On the drive to Gorkhi-Terelj, we'll stop just outside the park to see the impressive mounted statue of Genghis Khan. </li>
                                 </ul>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>Today is one entirely dedicated to exploring the park. Depending on what you're feeling, you can visit the monastery and meditation center, set out for a hike, or go for a horseback ride.  </li>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   ...
                                   <li>We'll celebrate our last night together with a farewell dinner, and raise our glasses to a trip packed with adventures. Tonight, back in a hotel, you might already begin missing our ger camp.</li>
                                 </ul>
                              ...
                              <div className="trip-day-wrap">
                                 ...
                                 <ul className="tripsUl">
                                   <li>Our trip concludes this morning. After one final breakfast together, we'll transfer you to the airport to depart home or onto your next destination.</li>
                                   <li>We'll celebrate our last night together with a farewell dinner, and raise our glasses to a trip packed with adventures. Tonight, back in a hotel, you might already begin missing our ger camp.</li>
                                 </ul>
                              </div>
                           </section>
